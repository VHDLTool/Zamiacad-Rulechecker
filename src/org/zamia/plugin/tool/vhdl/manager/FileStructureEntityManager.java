...
public class FileStructureEntityManager extends ToolManager {
	...
	public void run(IAction action) {
		...
		try {
			...
			ArrayList<Entity> listEntity = EntityManager.getArrayListEntity();
			for (Entity entityElement : listEntity) {
					write("sourcefile "+entityElement.getSourceFile().getFileName()+ "nb lines:"+entityElement.getSourceFile().getNumLines());
					nodeToLogger(entityElement);
			...
			logger.error("some exception message FileStructureEntityManager", e);
			return;
		}
