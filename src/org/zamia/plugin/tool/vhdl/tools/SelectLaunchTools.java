 ...
 */
public class SelectLaunchTools implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
        ...
        final ZDialogTool zd = ZDialogTool.getInstance(zPrj);
        zd.addWindowListener(new java.awt.event.WindowAdapter() {
		    @Override
		    public void windowClosing(java.awt.event.WindowEvent windowEvent) {
		    	zd.updateConfigSelectedTools();
		    }
		});
