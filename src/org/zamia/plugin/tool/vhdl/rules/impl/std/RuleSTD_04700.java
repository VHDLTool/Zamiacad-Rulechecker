...
public class RuleSTD_04700 extends Rule {
	...
	private class Violation {
		...
		public void generate(ReportFile reportFile, List<IHandbookParam> parameterList, int nbFailure) {
			...
			{
				reportFile.addSonarTags(info, SonarQubeRule.SONAR_ERROR_STD_04700, new Object[] {_entityId}, SonarQubeRule.SONAR_MSG_STD_04700, new Object[] {nbFailure, paramRelation, paramValue, _entityId});
			}
