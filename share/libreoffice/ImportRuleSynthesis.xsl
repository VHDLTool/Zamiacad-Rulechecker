...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   exclude-result-prefixes="office table text rc">
	...
	<xsl:template name="ColumnsConfiguration">
		...
		<table:table-column table:style-name="co5" table:default-cell-style-name="Default"/> <!-- Nb Failed -->
		<table:table-column table:style-name="co6" table:default-cell-style-name="Default"/> <!-- File -->
	</xsl:template>
