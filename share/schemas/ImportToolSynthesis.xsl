...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   exclude-result-prefixes="office table text rc">
	...
	<xsl:template name="ColumnsConfiguration">
		...
		<table:table-column table:style-name="co3" table:default-cell-style-name="Default"/> <!-- UID -->
		<table:table-column table:style-name="co4" table:default-cell-style-name="Default"/> <!-- Status -->
		<table:table-column table:style-name="co5" table:default-cell-style-name="Default"/> <!-- File -->
	</xsl:template>
	...
	<xsl:template name="Headers">
		...
		<table:table-cell office:value-type="string"><text:p>Tool name</text:p></table:table-cell>
	...
	<xsl:template name="Elements">
		<table:table-cell><text:p><xsl:value-of select="/rc:toolReporting/rc:ruleCheckerVersion"/></text:p></table:table-cell>
		<table:table-cell><text:p><xsl:value-of select="/rc:toolReporting/rc:executionDate"/></text:p></table:table-cell>
			...
			<office:body>
				<office:spreadsheet>
					<table:table>
						...
						<!-- ================= Body =========================== -->
						<xsl:for-each select="rc:toolReporting/rc:Tool">
							<xsl:choose>
